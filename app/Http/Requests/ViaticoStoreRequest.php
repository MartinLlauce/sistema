...
class ViaticoStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'idArea' => 'not_in:0',
            'documento_solicitud' => 'string|required|unique:viatico,documento_solicitud|min:5|max:90',
            'documento_autorizacion' => 'string|required|unique:viatico,documento_autorizacion|min:5|max:90',
