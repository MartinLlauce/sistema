...
class FielUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'documento_remision' => 'string|required|unique:fiel,documento_remision,'.$this->idFiel.',idFiel|min:5|max:90',
            'fecha_remision'=> 'required',
            'fecha_recepcion'=> 'required',
            'contrato' => 'string|required|unique:fiel,contrato,'.$this->idFiel.',idFiel|min:5|max:90',
