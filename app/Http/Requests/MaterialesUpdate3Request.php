...
class MaterialesUpdate3Request extends FormRequest
{
    /**
    ...
    {
        return [
            'documento_remision' => 'string|required|unique:materiales,documento_remision,'.$this->idMateriales.',idMateriales|min:5|max:90',
            'fecha_remision'=> 'required',
            'fecha_recepcion'=> 'required',
            'contrato' => 'string|required|unique:materiales,contrato,'.$this->idMateriales.',idMateriales|min:5|max:90',
            'monto_contrato' => 'required|numeric|min:1|max:99999999',
            'obra' => 'string|required|unique:materiales,obra,'.$this->idMateriales.',idMateriales|min:5|max:90',
            ...
            'monto_adelanto_3' => 'required|numeric|min:1|max:99999999',
            'fecha_desde_adelanto_3'=> 'required',
            'fecha_hasta_adelanto_3'=> 'required',
            'monto_adelanto_4' => 'required|numeric|min:1|max:99999999',
            'fecha_desde_adelanto_4'=> 'required',
            'fecha_hasta_adelanto_4'=> 'required'
    ...
    public function messages(){
        return [
            ...
            'fecha_desde_adelanto_3.required' => 'Ingrese Fecha.',
            'fecha_hasta_adelanto_3.required' => 'Ingrese Fecha.',
            'monto_adelanto_3.required' => 'Ingrese monto.',
            'monto_adelanto_3.numeric' => 'Ingrese monto correcto.',
            'monto_adelanto_3.min' => 'Rangos desde 1 hasta 99,999,999.',
            'monto_adelanto_3.max' => 'Rangos desde 1 hasta 99,999,999.',
            'fecha_desde_adelanto_4.required' => 'Ingrese Fecha.',
            'fecha_hasta_adelanto_4.required' => 'Ingrese Fecha.',
            'monto_adelanto_4.required' => 'Ingrese monto.',
            'monto_adelanto_4.numeric' => 'Ingrese monto correcto.',
            'monto_adelanto_4.min' => 'Rangos desde 1 hasta 99,999,999.',
            'monto_adelanto_4.max' => 'Rangos desde 1 hasta 99,999,999.',
        ];
    }
}
