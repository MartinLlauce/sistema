...
class EncargoUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'idArea' => 'not_in:0',
            'documento_solicitud' => 'string|required|unique:encargo,documento_solicitud,'.$this->idEncargo.',idEncargo|min:5|max:90',
            'documento_autorizacion' => 'string|required|unique:encargo,documento_autorizacion,'.$this->idEncargo.',idEncargo|min:5|max:90',
