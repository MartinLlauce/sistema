...
class DirectoStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'documento_remision' => 'string|required|unique:directo,documento_remision|min:5|max:90',
            'fecha_remision'=> 'required',
            'fecha_recepcion'=> 'required',
            'contrato' => 'string|required|unique:directo,contrato|min:5|max:90',
            'monto_contrato' => 'required|numeric|min:1|max:99999999',
            'obra' => 'string|required|unique:directo,obra|min:5|max:90',
